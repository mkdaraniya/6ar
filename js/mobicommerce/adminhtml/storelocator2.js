                    ...
                    if (transport.responseText) {
                        ...
                        Calendar.setup({
                            ...
                            disableFunc: function(date) {
                                ...
                                storelocator.changeDate($('changedate_url').value, $('changedate_format').value);
                            }
...
Storelocator.prototype = {
    ...
    changeStore: function() {
        ...
        if ($('storelocator-box') && $('storelocator-box') != null)
