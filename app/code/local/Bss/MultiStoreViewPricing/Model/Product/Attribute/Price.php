...
*/
class Bss_MultiStoreViewPricing_Model_Product_Attribute_Price extends Mage_Catalog_Model_Product_Attribute_Backend_Price
{
	public function setScope($attribute)
    {
        ...
        }elseif (Mage::helper('catalog')->isPriceGlobal()) {
    ...
    public function afterSave($object)
    {
        ...
        if ($this->getAttribute()->getIsGlobal() == Mage_Catalog_Model_Resource_Eav_Attribute::SCOPE_WEBSITE || $this->getAttribute()->getIsGlobal() == Mage_Catalog_Model_Resource_Eav_Attribute::SCOPE_STORE) {
