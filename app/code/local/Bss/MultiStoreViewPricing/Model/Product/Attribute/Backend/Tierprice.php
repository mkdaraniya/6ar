...
*/
class Bss_MultiStoreViewPricing_Model_Product_Attribute_Backend_Tierprice
    extends Bss_MultiStoreViewPricing_Model_Product_Attribute_Backend_Groupprice_Abstract
{
    ...
    {
        return Mage::getResourceSingleton('multistoreviewpricing/product_attribute_backend_tierprice');
    }
