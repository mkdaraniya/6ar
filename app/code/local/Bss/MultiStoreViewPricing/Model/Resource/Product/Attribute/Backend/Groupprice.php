...
*/
class Bss_MultiStoreViewPricing_Model_Resource_Product_Attribute_Backend_Groupprice extends Bss_MultiStoreViewPricing_Model_Resource_Product_Attribute_Backend_Groupprice_Abstract
{
    /**
    ...
    {
        $this->_init('multistoreviewpricing/group_price', 'value_id');
    }
