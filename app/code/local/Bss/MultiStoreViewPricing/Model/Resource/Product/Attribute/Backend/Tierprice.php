...
*/
class Bss_MultiStoreViewPricing_Model_Resource_Product_Attribute_Backend_Tierprice extends Bss_MultiStoreViewPricing_Model_Resource_Product_Attribute_Backend_Groupprice_Abstract
{
    /**
    ...
    {
        $this->_init('multistoreviewpricing/tier_price', 'value_id');
    }
