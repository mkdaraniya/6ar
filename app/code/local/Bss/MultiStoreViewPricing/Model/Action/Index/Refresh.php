...
*/
class Bss_MultiStoreViewPricing_Model_Action_Index_Refresh extends Mage_CatalogRule_Model_Action_Index_Refresh
{
	/**
     * Run reindex
     */
    ...
    {
        if(Mage::helper('multistoreviewpricing')->isScopePrice() == 0) return parent::execute();
    ...
    {
        if(Mage::helper('multistoreviewpricing')->isScopePrice() == 0) return parent::_reindex($website, $timestamp);
    ...
    {
        if(Mage::helper('multistoreviewpricing')->isScopePrice() == 0) return parent::_prepareTemporarySelect($website);
        ...
        $select = $this->_connection->select()
            ...
            ->joinLeft(
                array(
                    'pg_store' => $this->_resource->getTable('multistoreviewpricing/group_price')
                ),
    ...
    {
        if(Mage::helper('multistoreviewpricing')->isScopePrice() == 0) return parent::_removeOldIndexData($website);

        $this->_connection->delete(
            $this->_resource->getTable('multistoreviewpricing/rule_product_price'),
    ...
    {
        if(Mage::helper('multistoreviewpricing')->isScopePrice() == 0) return parent::_fillIndexData($website, $time);
    ...
    {
        if(Mage::helper('multistoreviewpricing')->isScopePrice() == 0) return parent::_prepareIndexSelect($website, $time);
