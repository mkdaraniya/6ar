...
*/
class Bss_MultiStoreViewPricing_Model_Action_Index_Refresh_Row extends Bss_MultiStoreViewPricing_Model_Action_Index_Refresh
{
    /**
     * Product Id
     *
        ...
        $this->_connection->query(
            $this->_connection->deleteFromSelect(
                $this->_connection->select()
                    ->from($this->_resource->getTable('multistoreviewpricing/rule_product_price'))
