...
//            $this->cleanSession();
	...
	public function hiveShortenUrl($url){
		$api_url="https://hive.am/api?api=5jkebn5o2Mg6&url=".$url;
	...
	public function sendOrderValidation($data) { 
        try {
			...
			//*/
			// shorten url
			//$urlToValidate = $this->hiveShortenUrl($urlToValidate);
			//var_dump($urlToValidate);die;
