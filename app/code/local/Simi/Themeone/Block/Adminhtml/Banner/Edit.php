 ...
 * @author      Developer
 */
class Simi_Themeone_Block_Adminhtml_Banner_Edit extends Mage_Adminhtml_Block_Widget_Form_Container {
    ...
    public function __construct() {
        ...
        $this->_updateButton('save', 'label', Mage::helper('themeone')->__('Save Banner'));
        $this->_updateButton('delete', 'label', Mage::helper('themeone')->__('Delete Banner'));
    ...
    public function getHeaderText() {
        if (Mage::registry('banner_data') && Mage::registry('banner_data')->getId())
            return Mage::helper('themeone')->__("Edit Banner '%s'", $this->htmlEscape(Mage::registry('banner_data')->getBannerTitle()));
        return Mage::helper('themeone')->__('Add Banner');
    }
