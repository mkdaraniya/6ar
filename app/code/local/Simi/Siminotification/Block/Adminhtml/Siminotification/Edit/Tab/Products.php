 ...
 * @author      Developer
 */
class Simi_Siminotification_Block_Adminhtml_Siminotification_Edit_Tab_Products extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    public function __construct($arguments = array()) {
        ...
        $this->setTemplate('siminotification/grid.phtml');
    }
    ...
    protected function _prepareColumns() {
        $this->addColumn('in_products', array(
            ...
            'use_index' => true,
            'width'     => '50px',
            'renderer' => 'siminotification/adminhtml_siminotification_edit_tab_renderer_sku'
        ));
