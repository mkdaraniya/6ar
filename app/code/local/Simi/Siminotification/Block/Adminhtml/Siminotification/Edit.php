 ...
 * @author      Developer
 */
class Simi_Siminotification_Block_Adminhtml_Siminotification_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
	...
	public function getHeaderText(){
		if(Mage::registry('siminotification_data') && Mage::registry('siminotification_data')->getId())
			return Mage::helper('siminotification')->__("Edit Message '%s'", $this->htmlEscape(Mage::registry('siminotification_data')->getNoticeTitle()));
