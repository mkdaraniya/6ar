 ...
 * @author      Developer
 */
class Magestore_RewardPoints_Model_Action_Spending_Cancel
    ...
    implements Magestore_RewardPoints_Model_Action_Interface
{
    ...
    {
        return Mage::helper('rewardpoints')->__('Retrieve points spent on cancelled order');
    }
    ...
    {
        $order = $this->getData('action_object');
        return Mage::helper('rewardpoints')->__('Retrieve points spent on cancelled order #%s', $order->getIncrementId());
    }
