 ...
 */
class Simi_Connector_Block_Adminhtml_Web_Switcher extends Mage_Adminhtml_Block_Template {
    /**
     * Key in config for store switcher hint
     */

    const XPATH_HINT_KEY = 'connector_web_switcher';
    ...
    public function __construct() {
        parent::__construct();
        $this->setTemplate('simi/connector/web/switcher.phtml');
