 ...
 * @author      Developer
 */
class Simi_Connector_Block_Adminhtml_Store_Switcher extends Mage_Adminhtml_Block_Template {
    /**
     * Key in config for store switcher hint
     */

    const XPATH_HINT_KEY = 'connector_store_switcher';
    ...
    public function __construct() {
        parent::__construct();
        $this->setTemplate('simi/connector/store/switcher.phtml');
    ...
    public function getWebsite(){
        ...
        $webSite = Mage::getModel('core/website')->load($web_id);
        return $webSite;
    }
    /**
     * Get websites
