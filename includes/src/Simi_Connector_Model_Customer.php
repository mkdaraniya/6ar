    ...
    public function saveAddressCustomer($data) {
        ...
        try {
            ...
            if (!$errors) {
                ...
                $data['latlng'] = $street[2] != NULL ? $street[2] : "";                
       ...
       $width = null;
        ...
        foreach ($allItems as $item) {
            ...
            $list[] = array(
                ...
                'options' => $options,
				'product_detail_info'=> $layernavigationObject->getProductDetailForListing($product),
            );
        }
    ...
    public function getOrderList($data) {
        ...
        foreach ($orders as $order) {
            ...
            if (++$check_limit > $limit)
                break;
            $createAt=Mage::helper('core')->formatDate($order->getCreatedAt(), Mage_Core_Model_Locale::FORMAT_TYPE_MEDIUM, true);
            $list[] = array(
