 ...
 */
class Simi_Themeone_Block_Adminhtml_Banner_Edit_Tab_Categories extends Mage_Adminhtml_Block_Catalog_Category_Tree
{
    ...
    {
        // die('333');
        $this->setTemplate('themeone/banner/categories.phtml');
    }
