...
/**
 * Popup Adminhtml Controller
 * 
 * @category    
 * @package     Popup
 * @author      Developer
 */
class Simi_Popup_Adminhtml_Popup_PopupController extends Mage_Adminhtml_Controller_Action {

    /**
     * init layout and set active for current menu
     *
     * @return Simi_Popup_Adminhtml_PopupController
     */
    protected function _initAction() {
			Zend_debug::dump($id);die();
        $this->loadLayout()
                ->_setActiveMenu('popup/popup')
    ...
    public function editAction() {
        ...
        if ($model->getId() || $id == 0) {
            ...
            $this->loadLayout();
            $this->_setActiveMenu('popup/popup');
    ...
    public function exportCsvAction() {
        $fileName = 'popup.csv';
        $content = $this->getLayout()->createBlock('popup/adminhtml_popup_grid')->getCsv();
    ...
    public function exportXmlAction() {
        $fileName = 'popup.xml';
        $content = $this->getLayout()->createBlock('popup/adminhtml_popup_grid')->getXml();
        $this->_prepareDownloadResponse($fileName, $content);
    }

    protected function _isAllowed() {
        return Mage::getSingleton('admin/session')->isAllowed('popup');
    }
