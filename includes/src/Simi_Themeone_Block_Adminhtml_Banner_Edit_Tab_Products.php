 ...
 */
class Simi_Themeone_Block_Adminhtml_Banner_Edit_Tab_Products extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    public function __construct($arguments = array()) {
        ...
        $this->setTemplate('themeone/banner/grid.phtml');
    }
    ...
    protected function _prepareColumns() {
        $this->addColumn('in_products', array(
            ...
            'use_index' => true,
            'width'     => '50px',
            'renderer' => 'themeone/adminhtml_banner_edit_tab_renderer_sku'
        ));
